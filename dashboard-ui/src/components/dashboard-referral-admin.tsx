    ...
    <div className={cn("mx-auto max-w-5xl space-y-8", isFa && "text-right")}>
      ...
      {stats ? (
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <StatCard label={tp("statReferralOnPurchases")} value={formatNumber(num(summary.totalReferralAmountOnPurchases), isFa)} />
        </div>
      ) : null}
      ...
      {referralEvents.length > 0 || (eventsPagination && eventsPagination.total > 0) ? (
        <Card>
          <CardHeader>
