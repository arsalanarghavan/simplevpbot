...
class SimpleVPBot_Plugin {
	...
	private static $class_map = array(
		...
		'SimpleVPBot_Model_Reseller_Wholesale_Line' => 'models/class-model-reseller-wholesale-line.php',
		'SimpleVPBot_Model_Reseller_Wholesale_Tier' => 'models/class-model-reseller-wholesale-tier.php',
		'SimpleVPBot_Model_Reseller_Wholesale_Assignment' => 'models/class-model-reseller-wholesale-assignment.php',
		'SimpleVPBot_Model_Reseller_Wholesale_Accrual' => 'models/class-model-reseller-wholesale-accrual.php',
		...
		'SimpleVPBot_Service_Naming'     => 'helpers/class-service-naming.php',
		'SimpleVPBot_Config_Inbound_Match' => 'helpers/class-config-inbound-match.php',
		'SimpleVPBot_Inbound_Display_Name' => 'helpers/class-inbound-display-name.php',
		'SimpleVPBot_Model_Reseller_Inbound_Display_Name' => 'models/class-model-reseller-inbound-display-name.php',
